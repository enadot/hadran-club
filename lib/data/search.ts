...
export const SEARCH_PAGES = [
  ...
  {
    name: "איפה מקבלים את הכרטיס",
    meta: "החנויות המשווקות של הדרן, לפי אזור ועיר — איסוף עצמי ללא עלות",
    href: "/stores",
    kw: "חנויות סניפים איסוף עצמי איפה מקבלים כרטיס משווקים כתובות",
  },
  {
    name: "הצטרפות להדרן",
    meta: "בחנויות המשווקות, או בהשארת פרטים לשיחה טלפונית",
    href: "/join-hadran",
    kw: "הצטרפות הדרן מכשיר שיחה טלפונית להשאיר פרטים חדש לקוח",
  },
  {
    name: "בדיקת יתרה",
...
export const SEARCH_FAQS = [
  ...
  {
    name: "איפה מקבלים כרטיס?",
    meta: "באיסוף עצמי מהחנויות המשווקות של הדרן, ללא עלות",
    href: "/faq",
    kw: "הזמנה כרטיס איסוף עצמי חנויות משווקות איך מקבלים",
  },
  {
